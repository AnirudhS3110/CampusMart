    ...
    return(
        <section className="">
            <div className="py-[30px] pt-[100px] w-[100%] bg-cblue ">
                <div className=" text-poppins  text-white lg:text-[40px] lg:font-semibold text-center">
        ...
        <div className=" w-[930px] h-[400px]  flex justify-between overflow-x-hidden">
            {
                ...
                cards.map((card,index)=>{
                    return(
                        <motion.div whileHover={{scale:1.1 , transition:{duration:0.2}}} key={index} className="min-w-[280px] max-w-[280px] max-h-[280px] flex flex-col justify-items-center align-middle min-h-[280px] px-[18px] pt-[15px] mr-[30px]  bg-cyello rounded-[20px]">

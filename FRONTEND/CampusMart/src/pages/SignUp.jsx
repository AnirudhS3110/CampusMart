    ...
    return(
        <section className="bg-[#05295e] flex items-center w-[100vw] h-[100vh]  md:px-[140px] ">
            ...
            <div className=" flex  flex-row justify-start flex-wrap mx-auto">
                    ...
                    <div className="bg-blue px-[30px]  md:bg-cyello flex flex-col md:flex align-middle h-auto min-w-[300px] max-w-[325px] md:min-w-[340px] rounded-[20px] text-white font-poppins border-white border-[2px] md:rounded-r-[0px] items-center">

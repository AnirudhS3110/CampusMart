    ...
    return(
        <CarouselContent className={`gap-[50px] md:gap-0`}>
            <CarouselItem className=" md:basis-1/2 lg:basis-1/4">
                                            <Card  className="bg-[#0f3772] max-w-[300px] min-w-[315px] min-h-[460px] max-h-[460px] md:max-w-[340px] border-[#07295c] flex flex-col justify-center" >
            ...
            {likedList.map((item)=><CarouselItem className="md:basis-1/2 lg:basis-1/4">
                                    <Card className="max-w-[325px] min-w-[315px] max-h-[460px] py-0 bg-[#0b336e] border-[#05295e] box-border">
                                                        ...
                                                        <CardContent className={`min-h-[300px] px-0 bg-[#05295e] pt-0 my-0 overflow-hidden rounded-[20px]`} >
                                                            <div className="min-w-[300px] w-[310px] max-w-[325px] h-[302px]  min-h-[300px] max-h-[306px] relative rounded-[20px] box-border">
                                                                <motion.img whileHover={{scale:1.03}} transition={{duration:0.2, ease: "easeInOut"}}  className="w-full h-full rounded-[20px]  object-cover" src={`${item.image}?nocache${new Date()}`} />
